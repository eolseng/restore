...
class DevProductsLoader @Autowired constructor(
    ...
    private fun insertBaseColors() {
        val baseColorNames: List<String> = mutableListOf("grey", "red", "blue", "navy", "white", "black", "green", "yellow", "brown", "orange", "pink", "purple", "phantom", "magnet", "micro chip", "norwegian mix", "bluebell", "nimbus cloud", "olive", "aubergine", "fire")
    ...
    private fun insertBaseProducts() {
        ...
        val productsFile = resourceLoader.getResource("classpath:DevProducts.json")
