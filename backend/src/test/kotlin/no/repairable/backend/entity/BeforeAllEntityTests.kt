...
class BeforeAllEntityTests {
    ...
    fun startup() {
        ...
        productRepository.save(Product(name = "Windorama", colors = colors, gender = male, category = category1, subCategory = subCategory1, sizes = sizes))
        productRepository.save(Product(name = "Skallorama", colors = colors, gender = female, category = category2, subCategory = subCategory2, sizes = sizes))
        productRepository.save(Product(name = "Skinnesen", colors = colors1, gender = male, category = category3, subCategory = subCategory4, sizes = sizes))
        productRepository.save(Product(name = "Vestesen", colors = colors1, gender = female, category = category3, subCategory = subCategory3, sizes = sizes))
