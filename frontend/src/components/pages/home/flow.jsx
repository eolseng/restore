      ...
      <div className='flow-content'>
        ...
        <div className='row icon-wrapper'>
          <div className='col-4 icon-container'>
            <img src={require("../../../img/icon/register.png")} alt='icon' />
            <h3>1. Registrer ditt plagg</h3>
            <p>Registrer plagget ved å klikke deg frem til det plagget du skal levere inn.</p>
          </div>
          <div className='col-4 icon-container'>
            <img src={require("../../../img/icon/value.png")} alt='icon' />
            <h3>2. Få estimert verdi</h3>
            <p>Motta et estimat på et gavekort hos gjeldende merke.</p>
          </div>
          <div className='col-4 icon-container'>
            <img src={require("../../../img/icon/wait.png")} alt='icon' />
            <h3>3. Send / Lever</h3>
            <p>
              Motta pose og send plagget til oss.
              <br /> Eller lever plagget i en butikk
            </p>
          </div>
        </div>
        <div className='row icon-wrapper'>
          ...
          <div className='col icon-container'>
            <img src={require("../../../img/icon/offer.png")} alt='icon' />
            <h3>4. Vent på vurdering</h3>
            <p>Vent på verdivurderingen fra våre eksperter (ca. 3 dager).</p>
          </div>
          <div className='col-4 icon-container'>
            <img src={require("../../../img/icon/ship.png")} alt='icon' />
