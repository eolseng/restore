    ...
    return (
        <div className="footer-container">
            ...
            <div className="footer-content col-3">
                <Link to=""> {/* finne ut hvordan man går til en ekstern side */}
            ...
            <div className="footer-content col-3">
                <div className="footer-wrapper">
                    ...
                    <Link to={"./FAQ"}><h5 className="footer-wrapper-content">FAQ</h5></Link>
            ...
            <div className="footer-content col-3">
                <div className="footer-wrapper">
                    <div className="socialMediaIcons">
                        <Link to=""><i className="fa fa-facebook-square bigFont"></i></Link>
                        <Link to=""><i className="fa fa-twitter-square bigFont"></i></Link>
                        <Link to=""><i className="fa fa-linkedin bigFont"></i></Link>
                    </div>
                </div>
            </div>
        </div>
